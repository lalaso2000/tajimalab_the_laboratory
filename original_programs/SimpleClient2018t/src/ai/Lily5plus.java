...
public class Lily5plus extends TajimaLabAI {
    ...
    private static final String[] MONEY_AND_RESERCH_PLACES_NAMES = {"1-1", "2-1", "2-2", "2-3", "5-3", "5-2", "5-1"};   // お金と研究ポイントの場所
    private static final String[] FINAL_1_PLACES_NAMES = {"1-1", "2-1", "2-2", "2-3", "5-3", "5-2", "5-1", "3-1", "3-2", "4-1"};  // 最終局面（夏〜秋）に使う場所
    ...
    public Lily5plus(Game game) {
        super(game);
        this.myName = "Lily5p v1.02(weighting 5-X)";
