...
public class PlayerPanel extends javax.swing.JPanel {
    ...
    public static String StartPlayerMakerImagePath = "images/startplayer.png";
    public static File StartPlayerMakerImage;
    ...
    public PlayerPanel(int playerID) {
        ...
        if(PlatformUtils.isWindows()){
            PlayerPanel.StartPlayerMakerImagePath = "images\\startplayer.png";
        }
        
        PlayerPanel.StartPlayerMakerImage = new File(PlayerPanel.StartPlayerMakerImagePath);
